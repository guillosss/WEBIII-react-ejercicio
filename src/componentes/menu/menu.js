...
function Menu(){
    ...
    <>
      <BrowserRouter>
      <Routes>
           <Route path="/ruta1" element={<Ruta1></Ruta1>}></Route>
           <Route path="/ruta2" element={<Ruta2></Ruta2>}></Route>
       </Routes>
        <nav className="w3-sidebar w3-collapse w3-white w3-animate-left" style={{zIndex:3,width:"300px"}} id="mySidebar"><br/>
          ...
          <div className="w3-bar-block">
            <a href="/"  className="w3-bar-item w3-button w3-padding w3-text-teal"><i className="fa fa-th-large fa-fw w3-margin-right"></i>PORTFOLIO</a> 
            ...
            <a href="/ruta1" className="w3-bar-item w3-button w3-padding"><i className="fa fa-envelope fa-fw w3-margin-right"></i>RUTA 1</a>
            <a href="/ruta2" className="w3-bar-item w3-button w3-padding"><i className="fa fa-envelope fa-fw w3-margin-right"></i>RUTA 2</a>
          </div>
